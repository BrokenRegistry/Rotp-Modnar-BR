...
public class Rotp {
    ...
    public static String jarFileName = "RotP-1.02a_modnar_MOD39_newRaces"+RotpGovernor.miniSuffix()+".jar";
    public static String exeFileName = "RotP-1.02a_modnar_MOD39_newRaces"+RotpGovernor.miniSuffix()+".exe";
    public static boolean countWords = false;
    private static String startupDir;
    private static JFrame frame;
    public static String releaseId = "1.02a modnar_MOD39_newRaces";
